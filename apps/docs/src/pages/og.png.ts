...
function ogSvg(title: string, subtitle: string): string {
  ...
  <text x="80" y="568" font-family="system-ui,-apple-system,sans-serif" font-size="22" fill="#8888a8">bpmn-sdk-docs.pages.dev</text>
</svg>`
}

export const GET: APIRoute = () => {
	const svg = ogSvg("BPMN SDK Docs", "API Reference &amp; Developer Guides")
